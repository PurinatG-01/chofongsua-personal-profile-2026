<template>
  <Transition name="fade">
    ...
    >
      <div class="w-full max-w-md space-y-4 px-6">
        <div class="border-border relative h-8 overflow-hidden border">
          <!-- Progress bar -->
          <div
        ...
        <p class="text-muted text-center text-xs">loading route…</p>
      </div>
    </div>
  </Transition>
</template>
