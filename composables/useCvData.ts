...
export const useCvData = () => {
  const profile: CvProfile = {
    ...
    tagline: 'Front-end developer crafting calm, maintainable web experiences with Nuxt, React, and modern JavaScript.',
    summary: [
    ...
    skillGroups: [
      {
        label: 'Frontend',
        items: ['JavaScript / TypeScript', 'Nuxt.js', 'Next.js', 'Vue', 'React', 'Svelte', 'HTML / CSS']
      },
      {
        label: 'Backend & APIs',
      ...
      },
      {
        ...
        items: ['Responsive UI', 'Performance awareness', 'Clean, readable code', 'Git-based workflow', 'Agile collaboration']
      }
    ],
    experiences: [
      {
